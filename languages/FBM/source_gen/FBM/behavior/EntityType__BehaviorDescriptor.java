...
public final class EntityType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> identifiyingFactType_id7S1crWQaQqD = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("identifiyingFactType").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("7S1crWQaQqD").registry(REGISTRY).build();

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(hasSimpleIdentifierBasedOn_id7S1crWQ18f3, identifiyingFactType_id7S1crWQaQqD);
  ...
  /*package*/ static SNode hasSimpleIdentifierBasedOn_id7S1crWQ18f3(@NotNull SNode __thisNode__) {
    ...
    if ((int) UniquenessConstraint__BehaviorDescriptor.Arity_id3neIg_bQBIB.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xc25c730f75b14ba8L, 0xbf0613ccd89082c9L, 0x35ceb9094bb228ddL, 0x7e0131bf35eff733L, "directlyIdentified"))) == 1) {
  ...
  /*package*/ static SNode identifiyingFactType_id7S1crWQaQqD(@NotNull SNode __thisNode__) {
    SNode factType = null;
    if ((int) UniquenessConstraint__BehaviorDescriptor.Arity_id3neIg_bQBIB.invoke(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xc25c730f75b14ba8L, 0xbf0613ccd89082c9L, 0x35ceb9094bb228ddL, 0x7e0131bf35eff733L, "directlyIdentified"))) == 1) {
      factType = SNodeOperations.cast(SNodeOperations.getParent(Sequence.fromIterable(SLinkOperations.collect(SLinkOperations.getChildren(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xc25c730f75b14ba8L, 0xbf0613ccd89082c9L, 0x35ceb9094bb228ddL, 0x7e0131bf35eff733L, "directlyIdentified")), MetaAdapterFactory.getContainmentLink(0xc25c730f75b14ba8L, 0xbf0613ccd89082c9L, 0x35ceb9094bd80217L, 0x35ceb9094bd80220L, "restricts")), MetaAdapterFactory.getReferenceLink(0xc25c730f75b14ba8L, 0xbf0613ccd89082c9L, 0x35ceb9094bd8021aL, 0x35ceb9094bd8021bL, "role"))).first()), MetaAdapterFactory.getConcept(0xc25c730f75b14ba8L, 0xbf0613ccd89082c9L, 0x35ceb9094baf5b2dL, "FBM.structure.FactType"));
    }
    return factType;
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 1:
        return (T) ((SNode) identifiyingFactType_id7S1crWQaQqD(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
